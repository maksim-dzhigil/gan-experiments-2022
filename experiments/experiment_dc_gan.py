...
from networks.gan_generator import GanGenerator
...
def conduct_experiment_dcgan(gen_optimizer: str = 'adam',
    ...
    generator = GanGenerator(image_size=gen_image_size,
    ...
    gan.compile(generator_optimizer, discriminator_optimizer, loss_fn)  # add loss_fn settings?
